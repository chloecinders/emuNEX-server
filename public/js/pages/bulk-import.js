                ...
                <div class="auth-card" style="width: 100%">
                    ...
                    <div class="content">
                        <p class="role-label" style="text-align: center; margin-bottom: var(--spacing-lg)">
                            Upload a unified ZIP file containing folders for each game. Each folder must have an
                            <code>info.json</code> file.
                        </p>
                        ...
                        <label class="file-drop" for="zip-upload">
                            <strong
                                >${this._selectedFileName
                                    ...
                                    : "Click to select a .ZIP file"}</strong
                            >
                            <input
                                type="file"
                                id="zip-upload"
                        ...
                        ${this.statusMsg
                            ? html` <div class="status-box status-${this.statusType}"> ${this.statusMsg} </div> `
                            : ""}

                        <div class="actions">
                            <button
                                class="popout-btn"
                                @click=${this._uploadZip}
                                ?disabled=${this.isUploading || !this._selectedFileName}
                            >
                                <span class="btn-edge"></span>
                                <span class="btn-front"
                                    >${this.isUploading ? "Uploading & Processing..." : "Upload & Process ZIP"}</span
                                >
                            </button>
                        </div>
                    </div>
